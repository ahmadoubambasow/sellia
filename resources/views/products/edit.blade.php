        ...
        <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            ...
            <form
                ...
                x-data="{
                    ...
                    get margin() {
                        return Number(this.sellingPrice || 0)
                ...
                <div class="space-y-6">
                            ...
                            <div class="grid gap-6 md:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <p class="mt-1.5 text-xs text-slate-400">
                                        Facultatif. Une référence permet d'identifier rapidement le produit.
                                    </p>
                                ...
                                <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                                    ...
                                    <div>
                                        ...
                                        <p class="mt-1 text-xs text-slate-500">
                                            La marge est recalculée automatiquement.
                                        </p>
                                    </div>
                    ...
                    <div class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
                        ...
                        <div class="border-b border-slate-100 px-6 py-5">
                            ...
                            <p class="mt-1 text-sm text-slate-500">
                                Ajustez la quantité et le seuil d'alerte.
                            </p>
                        </div>
                        ...
                        <div class="space-y-6 p-6">
                            ...
                            <div class="grid gap-6 md:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <p class="mt-1.5 text-xs text-slate-400">
                                        Une alerte apparaît lorsque le stock est inférieur ou égal à ce seuil.
                                    </p>
                                ...
                                <label class="flex cursor-pointer items-start gap-3">
                                    ...
                                    <span>
                                        ...
                                        <span class="mt-1 block text-xs leading-5 text-slate-500">
                                            Un produit actif peut être utilisé dans les ventes.
                                        </span>
                                    </span>
